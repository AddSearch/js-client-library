 ...
 */
!function(e,n){t.exports=n()}(0,function(){"use strict";function t(t){return"function"==typeof t}var r=Array.isArray?Array.isArray:function(t){return"[object Array]"===Object.prototype.toString.call(t)},i=0,s=void 0,o=void 0,a=function(t,e){p[i]=t,p[i+1]=e,2===(i+=2)&&(o?o(g):y())};var u="undefined"!=typeof window?window:void 0,c=u||{},h=c.MutationObserver||c.WebKitMutationObserver,f="undefined"==typeof self&&void 0!==e&&"[object process]"==={}.toString.call(e),l="undefined"!=typeof Uint8ClampedArray&&"undefined"!=typeof importScripts&&"undefined"!=typeof MessageChannel;function d(){var t=setTimeout;return function(){return t(g,1)}}var p=new Array(1e3);function g(){for(var t=0;t<i;t+=2){(0,p[t])(p[t+1]),p[t]=void 0,p[t+1]=void 0}i=0}var y=void 0;function v(t,e){var n=this,r=new this.constructor(w);void 0===r[m]&&U(r);var i=n._state;if(i){var s=arguments[i-1];a(function(){return k(i,r,s,n._result)})}else j(n,r,t,e);return r}function b(t){if(t&&"object"==typeof t&&t.constructor===this)return t;var e=new this(w);return x(e,t),e}y=f?function(){return e.nextTick(g)}:h?function(){var t=0,e=new h(g),n=document.createTextNode("");return e.observe(n,{characterData:!0}),function(){n.data=t=++t%2}}():l?function(){var t=new MessageChannel;return t.port1.onmessage=g,function(){return t.port2.postMessage(0)}}():void 0===u?function(){try{var t=Function("return this")().require("vertx");return void 0!==(s=t.runOnLoop||t.runOnContext)?function(){s(g)}:d()}catch(t){return d()}}():d();var m=Math.random().toString(36).substring(2);function w(){}var _=void 0,F=1,T=2,A={error:null};function E(t){try{return t.then}catch(t){return A.error=t,A}}function S(e,n,r){n.constructor===e.constructor&&r===v&&n.constructor.resolve===b?function(t,e){e._state===F?O(t,e._result):e._state===T?B(t,e._result):j(e,void 0,function(e){return x(t,e)},function(e){return B(t,e)})}(e,n):r===A?(B(e,A.error),A.error=null):void 0===r?O(e,n):t(r)?function(t,e,n){a(function(t){var r=!1,i=function(t,e,n,r){try{t.call(e,n,r)}catch(t){return t}}(n,e,function(n){r||(r=!0,e!==n?x(t,n):O(t,n))},function(e){r||(r=!0,B(t,e))},t._label);!r&&i&&(r=!0,B(t,i))},t)}(e,n,r):O(e,n)}function x(t,e){t===e?B(t,new TypeError("You cannot resolve a promise with itself")):!function(t){var e=typeof t;return null!==t&&("object"===e||"function"===e)}(e)?O(t,e):S(t,e,E(e))}function P(t){t._onerror&&t._onerror(t._result),C(t)}function O(t,e){t._state===_&&(t._result=e,t._state=F,0!==t._subscribers.length&&a(C,t))}function B(t,e){t._state===_&&(t._state=T,t._result=e,a(P,t))}function j(t,e,n,r){var i=t._subscribers,s=i.length;t._onerror=null,i[s]=e,i[s+F]=n,i[s+T]=r,0===s&&t._state&&a(C,t)}function C(t){var e=t._subscribers,n=t._state;if(0!==e.length){for(var r=void 0,i=void 0,s=t._result,o=0;o<e.length;o+=3)r=e[o],i=e[o+n],r?k(n,r,i,s):i(s);t._subscribers.length=0}}function k(e,n,r,i){var s=t(r),o=void 0,a=void 0,u=void 0,c=void 0;if(s){if((o=function(t,e){try{return t(e)}catch(t){return A.error=t,A}}(r,i))===A?(c=!0,a=o.error,o.error=null):u=!0,n===o)return void B(n,new TypeError("A promises callback cannot return that same promise."))}else o=i,u=!0;n._state!==_||(s&&u?x(n,o):c?B(n,a):e===F?O(n,o):e===T&&B(n,o))}var z=0;function U(t){t[m]=z++,t._state=void 0,t._result=void 0,t._subscribers=[]}var R=function(){function t(t,e){this._instanceConstructor=t,this.promise=new t(w),this.promise[m]||U(this.promise),r(e)?(this.length=e.length,this._remaining=e.length,this._result=new Array(this.length),0===this.length?O(this.promise,this._result):(this.length=this.length||0,this._enumerate(e),0===this._remaining&&O(this.promise,this._result))):B(this.promise,new Error("Array Methods must be provided an Array"))}return t.prototype._enumerate=function(t){for(var e=0;this._state===_&&e<t.length;e++)this._eachEntry(t[e],e)},t.prototype._eachEntry=function(t,e){var n=this._instanceConstructor,r=n.resolve;if(r===b){var i=E(t);if(i===v&&t._state!==_)this._settledAt(t._state,e,t._result);else if("function"!=typeof i)this._remaining--,this._result[e]=t;else if(n===D){var s=new n(w);S(s,t,i),this._willSettleAt(s,e)}else this._willSettleAt(new n(function(e){return e(t)}),e)}else this._willSettleAt(r(t),e)},t.prototype._settledAt=function(t,e,n){var r=this.promise;r._state===_&&(this._remaining--,t===T?B(r,n):this._result[e]=n),0===this._remaining&&O(r,this._result)},t.prototype._willSettleAt=function(t,e){var n=this;j(t,void 0,function(t){return n._settledAt(F,e,t)},function(t){return n._settledAt(T,e,t)})},t}();var D=function(){function e(t){this[m]=z++,this._result=this._state=void 0,this._subscribers=[],w!==t&&("function"!=typeof t&&function(){throw new TypeError("You must pass a resolver function as the first argument to the promise constructor")}(),this instanceof e?function(t,e){try{e(function(e){x(t,e)},function(e){B(t,e)})}catch(e){B(t,e)}}(this,t):function(){throw new TypeError("Failed to construct 'Promise': Please use the 'new' operator, this object constructor cannot be called as a function.")}())}return e.prototype.catch=function(t){return this.then(null,t)},e.prototype.finally=function(e){var n=this.constructor;return t(e)?this.then(function(t){return n.resolve(e()).then(function(){return t})},function(t){return n.resolve(e()).then(function(){throw t})}):this.then(e,e)},e}();return D.prototype.then=v,D.all=function(t){return new R(this,t).promise},D.race=function(t){var e=this;return r(t)?new e(function(n,r){for(var i=t.length,s=0;s<i;s++)e.resolve(t[s]).then(n,r)}):new e(function(t,e){return e(new TypeError("You must pass an array to race."))})},D.resolve=b,D.reject=function(t){var e=new this(w);return B(e,t),e},D._setScheduler=function(t){o=t},D._setAsap=function(t){a=t},D._asap=a,D.polyfill=function(){var t=void 0;if(void 0!==n)t=n;else if("undefined"!=typeof self)t=self;else try{t=Function("return this")()}catch(t){throw new Error("polyfill failed because global object is unavailable in this environment")}var e=t.Promise;if(e){var r=null;try{r=Object.prototype.toString.call(e.resolve())}catch(t){}if("[object Promise]"===r&&!e.cast)return}t.Promise=D},D.Promise=D,D})}).call(this,n(5),n(4))},function(t,e,n){"use strict";n(6).polyfill(),n(3);t.exports=function(t,e,n,r){var i=function(t,e){return t?"&"+e+"="+t:""};if("search"===e||"suggest"===e){var s="",o="";if("search"===e){if(s=(s=n.keyword).replace(/ and /g," AND ").replace(/ or /g," OR ").replace(/ not /g," NOT "),s=encodeURIComponent(s),"search"===e){if(o=i(n.lang,"lang")+i(n.fuzzy,"fuzzy")+i(n.categories,"categories")+i(n.priceFromCents,"priceFromCents")+i(n.priceToCents,"priceToCents")+i(n.dateFrom,"dateFrom")+i(n.dateTo,"dateTo")+i(n.paging.page,"page")+i(n.paging.pageSize,"limit")+i(n.paging.sortBy,"sort")+i(n.paging.sortOrder,"order")+i(n.jwt,"jwt")+i(n.resultType,"resultType")+i(n.userToken,"userToken"),n.customFieldFilters)for(var a=0;a<n.customFieldFilters.length;a++)o=o+"&customField="+n.customFieldFilters[a];if(n.facetFields)for(a=0;a<n.facetFields.length;a++)o=o+"&facet="+n.facetFields[a];if(n.personalizationEvents&&Array.isArray(n.personalizationEvents))for(a=0;a<n.personalizationEvents.length;a++){var u=n.personalizationEvents[a],c=Object.keys(u);o=o+"&personalizationEvent="+encodeURIComponent(c+"="+u[c])}}}else"suggest"===e&&(o=i(n.suggestionsSize,"size"),s=n.suggestionsPrefix);fetch("https://api.addsearch.com/v1/"+e+"/"+t+"?term="+s+o).then(function(t){return t.json()}).then(function(t){r(t)}).catch(function(t){console.log(t),r({error:{response:500,message:"invalid server response"}})})}else r({error:{response:400,message:"invalid query type"}})}},function(t,e,n){"use strict";var r=n(7),i=n(1),s=n(0);t.exports=function(t){this.sitekey=t,this.settings=new i,this.search=function(t,e){var n=null,i=null;if(t&&s.isFunction(e))n=t,i=e;else if(!e&&s.isFunction(t))n=this.settings.getSettings().keyword,i=t;else{if(!this.settings.getSettings().callback)throw"Illegal search parameters. Should be (keyword, callbackFunction) or (callbackFunction)";n=this.settings.getSettings().keyword,i=this.settings.getSettings().callback}this.settings.setCallback(i),this.settings.setKeyword(n),r(this.sitekey,"search",this.settings.getSettings(),i)},this.suggestions=function(t,e){if(!t||!e||!s.isFunction(e))throw"Illegal suggestions parameters. Should be (prefix, callbackFunction)";this.settings.setSuggestionsPrefix(t),r(this.sitekey,"suggest",this.settings.getSettings(),e)},this.getSettings=function(){return this.settings.getSettings()},this.setLanguage=function(t){this.settings.setLanguage(t)},this.useFuzzyMatch=function(t){this.settings.useFuzzyMatch(t)},this.setCategoryFilters=function(t){this.settings.setCategoryFilters(t)},this.addCustomFieldFilter=function(t,e){this.settings.addCustomFieldFilter(t,e)},this.removeCustomFieldFilter=function(t,e){this.settings.removeCustomFieldFilter(t,e)},this.setPriceRangeFilter=function(t,e){this.settings.setPriceRangeFilter(t,e)},this.setDateFilter=function(t,e){this.settings.setDateFilter(t,e)},this.setJWT=function(t){this.settings.setJWT(t)},this.setUserToken=function(t){this.settings.setUserToken(t)},this.setPaging=function(t,e,n,r){this.settings.setPaging(t,e,n,r)},this.nextPage=function(){this.settings.nextPage()},this.previousPage=function(){this.settings.previousPage()},this.setSuggestionsSize=function(t){this.settings.setSuggestionsSize(t)},this.addFacetField=function(t){this.settings.addFacetField(t)},this.setResultType=function(t){this.settings.setResultType(t)},this.setPersonalizationEvents=function(t){this.settings.setPersonalizationEvents(t)}}}]);